          ...
          <div>
            <div>
              ...
              <p class="product-details-value">
                {
                  <ul>
                    {props.clickId.categoryContent.details.map(s => (
                      <li>{s}</li>
                    ))}
                  </ul>
                }
              ...
              <p class="product-details-value">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    {props.clickId.categoryContent.checker.map(s => (
                      <tr>
                        <td>{s.capacity}</td>
                        <td>{s.accuracy}</td>
                        <td>{s.panSize}</td>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    {props.clickId.categoryContent.floorScale.map(s => (
                      <tr>
                        <td>{s.capacity}</td>
                        <td>{s.accuracy}</td>
                        <td>{s.panSize}</td>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    {props.clickId.categoryContent.dualLoadCell.map(s => (
                      <tr>
                        <td>{s.capacity}</td>
                        <td>{s.accuracy}</td>
                        <td>{s.panSize}</td>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    {props.clickId.categoryContent.fourLoadCell.map(s => (
                      <tr>
                        <td>{s.capacity}</td>
                        <td>{s.accuracy}</td>
                        <td>{s.panSize}</td>
